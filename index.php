...
<!-- Chatbot Modal -->
<div id="chatModal" class="fixed inset-0 bg-black/50 hidden justify-center items-center z-50">
    <div class="relative w-96 h-[600px] bg-[#0B0F19] rounded-2xl shadow-xl">
        <button id="closeChat" class="absolute top-3 right-3 text-white text-xl font-bold hover:text-gray-300">&times;</button>
        <iframe src="https://chatbot-vercel-navy.vercel.app/" class="w-full h-full rounded-2xl" frameborder="0"></iframe>
    </div>
</div>
<script>
    ...
    toggles.forEach(toggle => {
        toggle.addEventListener('click', () => {
            ...
            const plus = toggle.querySelector('span:last-child');
